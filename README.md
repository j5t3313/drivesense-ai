...
├── barber/                          # Raw Barber telemetry 
│   ├── R1_barber_telemetry_data.csv
│   ├── R2_barber_telemetry_data.csv
│   └── [other Barber CSV files]
├── indianapolis/                    # Raw Indianapolis telemetry 
│   ├── R1_indianapolis_telemetry_data.csv
│   ├── R2_indianapolis_telemetry_data.csv
│   └── [other Indianapolis CSV files]
├── processed_data/                  # Generated by preprocess_data.py
│   ├── barber/
│   │   ├── metadata.json
│   │   └── [individual lap CSV files]
│   └── indianapolis/
│       ├── metadata.json
│       └── [individual lap CSV files]
